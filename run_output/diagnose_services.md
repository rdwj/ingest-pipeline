...
```
    ...
    Response: {"status":"healthy","timestamp":"2025-11-14T04:00:51.598445","version":"1.0.0","service":"vector-search-service","uptime":0.001106,"components":{"database":{"status":"healthy","message":"Database connection OK","response_time_ms":1},"response_time_seconds":0.001106}}
    SUCCESS: Service is up
    Health data: {'status': 'healthy', 'timestamp': '2025-11-14T04:00:51.598445', 'version': '1.0.0', 'service': 'vector-search-service', 'uptime': 0.001106, 'components': {'database': {'status': 'healthy', 'message': 'Database connection OK', 'response_time_ms': 1}, 'response_time_seconds': 0.001106}}
...
```
    ...
    ai-poc-0                                                               2/2     Running     0             67m
    doc-ingest-service-587c66f6-brbdp                                      1/1     Running     0             9h
    document-ingestion-pipeline-4g9jc-system-container-driver-1536953863   0/2     Completed   0             5h58m
    document-ingestion-pipeline-4g9jc-system-container-driver-2271643386   0/2     Completed   0             5h58m
    document-ingestion-pipeline-4g9jc-system-container-driver-2759241689   0/2     Completed   0             5h58m
    document-ingestion-pipeline-4g9jc-system-container-driver-2807402198   0/2     Completed   0             5h58m
    document-ingestion-pipeline-4g9jc-system-dag-driver-1356581177         0/2     Completed   0             5h58m
    document-ingestion-pipeline-4g9jc-system-dag-driver-3100529394         0/2     Completed   0             5h58m
    ...
    document-ingestion-pipeline-mgpfv-system-container-driver-2058975841   0/2     Completed   0             6h5m
    document-ingestion-pipeline-mgpfv-system-container-driver-2164359667   0/2     Completed   0             6h5m
    document-ingestion-pipeline-mgpfv-system-container-driver-2516303924   0/2     Completed   0             6h4m
    document-ingestion-pipeline-mgpfv-system-container-driver-3247826154   0/2     Completed   0             6h5m
    document-ingestion-pipeline-mgpfv-system-dag-driver-449253610          0/2     Completed   0             6h5m
    document-ingestion-pipeline-mgpfv-system-dag-driver-707995373          0/2     Completed   0             6h5m
    document-ingestion-pipeline-qmggd-system-container-driver-2082026445   0/2     Completed   0             140m
    document-ingestion-pipeline-qmggd-system-container-driver-2215038023   0/2     Completed   0             140m
    document-ingestion-pipeline-qmggd-system-container-driver-612687800    0/2     Completed   0             139m
    document-ingestion-pipeline-qmggd-system-container-driver-729955310    0/2     Completed   0             140m
    document-ingestion-pipeline-qmggd-system-dag-driver-2561816417         0/2     Completed   0             140m
    document-ingestion-pipeline-qmggd-system-dag-driver-3567376958         0/2     Completed   0             140m
    document-ingestion-pipeline-szqgt-system-container-driver-2183277301   0/2     Completed   0             7h9m
    document-ingestion-pipeline-szqgt-system-container-driver-2225480755   0/2     Completed   0             7h9m
    document-ingestion-pipeline-szqgt-system-container-driver-632836102    0/2     Completed   0             7h9m
    document-ingestion-pipeline-szqgt-system-container-driver-647065738    0/2     Completed   0             7h9m
    document-ingestion-pipeline-szqgt-system-container-impl-1372119987     0/2     Completed   0             7h8m
    document-ingestion-pipeline-szqgt-system-dag-driver-1562604654         0/2     Completed   0             7h9m
    document-ingestion-pipeline-szqgt-system-dag-driver-2553406981         0/2     Completed   0             7h9m
    document-ingestion-pipeline-szssb-system-container-driver-1051677951   0/2     Completed   0             102m
    document-ingestion-pipeline-szssb-system-container-driver-4020175102   0/2     Completed   0             102m
    document-ingestion-pipeline-szssb-system-container-driver-4032523121   0/2     Completed   0             101m
    document-ingestion-pipeline-szssb-system-container-driver-903402578    0/2     Completed   0             102m
    document-ingestion-pipeline-szssb-system-container-impl-1059536764     0/2     Completed   0             102m
    document-ingestion-pipeline-szssb-system-container-impl-134966097      0/2     Completed   0             102m
    document-ingestion-pipeline-szssb-system-container-impl-297837375      0/2     Completed   0             101m
    document-ingestion-pipeline-szssb-system-container-impl-3904315736     0/2     Completed   0             101m
    document-ingestion-pipeline-szssb-system-dag-driver-49759658           0/2     Completed   0             102m
    document-ingestion-pipeline-szssb-system-dag-driver-570490929          0/2     Completed   0             102m
    ds-pipeline-dspa-6f479b69dd-kmsn9                                      2/2     Running     3 (9h ago)    9h
    ...
    vector-search-service-6d7957f84c-7shbb                                 1/1     Running     1 (15m ago)   9h
